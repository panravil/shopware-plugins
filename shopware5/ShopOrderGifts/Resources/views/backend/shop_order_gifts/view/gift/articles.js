...
//{block name="backend/shop_order_gifts/view/gifts/articles"}
Ext.define( "Shopware.apps.ShopOrderGifts.view.gift.Articles",
{
    // parent
    ...
    // alias
    alias:'widget.gifts-gift-articles',
    ...
    source:
        {
            alias:  "widget.gifts-gift-articles-source-grid",
            itemId: "gifts-gift-articles-source-grid"
        },

    // target configuration
    target:
        {
            alias:  "widget.gifts-gift-articles-target-grid",
            itemId: "gifts-gift-articles-target-grid"
        },
        ...
        var button_add = Ext.create( "Ext.Button",
            {
                ...
                listeners: {
                    scope: me,
                    click: function() {
                        me.fireEvent( me.eventNames.onItemsAdd, me.store );
                    }
                }
            }
        );
        ...
        var button_remove = Ext.create( "Ext.Button",
            {
                ...
                listeners: {
                    scope: me,
                    click: function(){
                        me.fireEvent( me.eventNames.onItemsRemove, me.store );
                    }
                }
            }
        );
