...
//{block name="backend/shop_order_gifts/view/gifts/customergroups"}
Ext.define( "Shopware.apps.ShopOrderGifts.view.gift.Customergroups",
{
    // parent
    ...
    // alias
    alias:'widget.gifts-gift-customergroups',

    // snippets
    snippets:
        {
            sourceGridTitle: "Verfügbare Kundengruppen",
            targetGridTitle: "Zugeordnete Kundengruppen",
            columnId:        "ID",
            columnName:      "Kundengruppe",
            buttonAdd:       "Kundengruppe(n) zuordnen",
            buttonRemove:    "Kundengruppe(n) entfernen",
            searchText:      "Suche...",
        },
    ...
    source:
        {
            alias:  "widget.gifts-gift-customergroups-source-grid",
            itemId: "gifts-gift-customergroups-source-grid"
        },

    // target configuration
    target:
        {
            alias:  "widget.gifts-gift-customergroups-target-grid",
            itemId: "gifts-gift-customergroups-target-grid"
        },
